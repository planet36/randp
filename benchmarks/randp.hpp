...
{
	static thread_local randp<RANDP_NUM_BLOCKS, RANDP_RESEED_COUNTDOWN_MIN>* this_ =
	    nullptr;

	// The whole struct must fit in one page.
	static_assert(sizeof(randp<RANDP_NUM_BLOCKS, RANDP_RESEED_COUNTDOWN_MIN>) <=
	              PAGE_SIZE);
...
randp_bytes_MUTEX(void* buf, size_t n)
{
	...
	static randp<RANDP_NUM_BLOCKS, RANDP_RESEED_COUNTDOWN_MIN>* this_ = nullptr;
