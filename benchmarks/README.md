...
`make mutex others pool-size prng-params reseed-countdown`
  ...
  - All the benchmarks take about 8.5 minutes.
...
|---|---:|---|
| `randp_bytes`    |  247  ms | 21.1&times; faster |
| `arc4random_buf` | 5211  ms | |
| `getentropy`     | 7465  ms | |
...
|---|---:|---|
| `randp_u32`  | 7.00  ns | 2.0&times; faster |
| `arc4random` | 14.0  ns | |
| `rdrand32`   |  291  ns | |
| `rdseed32`   | 1825  ns | |
...
| Function | Median time per call | |
|---|---:|---|
| `randp_lt_u32`       | 7.19  ns | 3.3&times; faster |
| `arc4random_uniform` | 23.6  ns | |
...
| Function | Median time to generate 4 GiB | |
|---|---:|---|
| `randp_bytes`    |  252  ms | 20.8&times; faster |
| `arc4random_buf` | 5230  ms | |
| `getentropy`     | 7702  ms | |
...
| Function | Median time per call | |
|---|---:|---|
| `randp_u32`  | 6.91  ns | 2.0&times; faster |
| `arc4random` | 14.0  ns | |
| `rdrand32`   |  293  ns | |
| `rdseed32`   | 1842  ns | |
...
| Function | Median time per call | |
|---|---:|---|
| `randp_lt_u32`       | 7.21  ns | 3.3&times; faster |
| `arc4random_uniform` | 24.0  ns | |
...
| Function | Median time per call | |
|---|---:|---|
| `randp_lt_u32`       | 6.43  ns | 3.6&times; faster |
| `arc4random_uniform` | 22.9  ns | |
